...
CREATE TABLE [cost].[AzureStaging](
	[InvoiceSectionName] [nvarchar](150) NULL,
	[AccountName] [nvarchar](150) NULL,
	[AccountOwnerId] [nvarchar](150) NULL,
	[SubscriptionId] [nvarchar](150) NULL,
...
CREATE TABLE [cost].[consumoAzure_agg](
	...
	[UnidadDeMedida] [nvarchar](200) NULL,
	...
	[Contenedor] [nvarchar](4000) NULL,
	[Propietario] [nvarchar](4000) NULL,
	[Recurso] [nvarchar](4000) NULL
);
...
-- Tabla especifica para el analisis de almacenamiento ---
CREATE TABLE [cost].[consumoAzure_agg_storage](
	[anioMes] [date] NULL,
	[IdInstancia] [nvarchar](200) NULL,
	[subCategoriaProducto] [nvarchar](300) NULL,
	[suscriptionID] [nvarchar](150) NULL,
	[suscriptionName] [nvarchar](200) NULL,
	[grupoRecursos] [nvarchar](150) NULL,
